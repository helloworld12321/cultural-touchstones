...
type Message
  ...
  The TransitionState parameter indicates what the next transition state should
  be, or Nothing, if the snackbar should be removed from the DOM. This allows
  the transition animation to skip backwards or forwards as necessary.
  -}
